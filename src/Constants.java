...
public class Constants {
	...
	public static final int GENERATION_LIMIT = 1000000;
	public static final double FITNESS_LIMIT = 160;
	
	// Environment Setup
	public static FileManager fm = new FileManager("C:\\Users\\cbadu\\eclipse-workspace\\Java Programs\\"
			+ "Genetic Algorithm for Robot Navigation\\Environment 1.txt");
